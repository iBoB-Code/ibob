...
import pic_Trippers from '../../assets/img/trippers.jpg';
import pic_Tripadvisor from '../../assets/img/apps/tripadvisor.png';
import pic_Agoda from '../../assets/img/apps/agoda.png';
import pic_Tricount from '../../assets/img/apps/tricount.png';
import pic_Airlines from '../../assets/img/apps/airlines.png';
import pic_Convert from '../../assets/img/apps/convert.png';
    ...
    return (
      <div className="roadtrip">
        ...
        <div className="container">
          ...
          <Image shape="circular" src={pic_Trippers} />
              ...
              <Card.Content>
                <ul>
                  <li>
                    ...
                    <div className="body">Je m'excuse par avance si vous en trouvez dans les centaines de lignes ci-dessous, mais il faut savoir que ce site a été codé et entièrement rédigé sans oublier le tri des photos en moins d’une semaine… Donc la relecture n’est pas encore passée par là…</div>
                  </li>
                  <li>
                    <div className="head">
                  ...
                  <li>
                    ...
                    <div className="apps">
                      <div className="app">
                        <div>
                          <Image src={pic_Tripadvisor} avatar />
                          <h4>TripAdvisor :</h4>
                        </div>
